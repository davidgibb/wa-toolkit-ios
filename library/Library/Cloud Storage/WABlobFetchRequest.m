...
{
    return [NSString stringWithFormat:@"BlobFetchRequest { container = %@, prefix = %@, resultContinuation = %@, useFlatListing = %c, maxResut = %lu }", _container, _prefix, _resultContinuation, _useFlatListing, (unsigned long)_maxResult];
}
